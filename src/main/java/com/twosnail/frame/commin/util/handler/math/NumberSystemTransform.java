package com.twosnail.frame.commin.util.handler.math;
 ...
 * @return 
 */
public class NumberSystemTransform {

//	public static void main(String[] args) {
//		String num = "78364164084";//"36";//"78364164095";
//		int bit = 36;
//		System.out.println("10进制是：" + NumberSystemTransform.anyToDecimal(NumberSystemTransform.decimalToAny(new BigInteger(num), bit), bit));
//		System.out.println(bit + "进制是：" + NumberSystemTransform.decimalToAny(new BigInteger(num), bit));
//		
//		System.out.println(NumberSystemTransform.anyToDecimal("ZZZZZZN", 36));
//	}
