package com.twosnail.frame.commin.util.handler.file;
...
import com.twosnail.frame.commin.util.handler.io.FileHandler;
...
public class ImageHandler {
	...
	public static void resize( InputStream source, String desc, final int descWidth, final int descHeight, boolean ratio ) 
	    ...
	    try {
		    ...
		    g.dispose();
		    File descFile = FileHandler.createFile( desc ) ;
